...
B3bActionInitialization::B3bActionInitialization
	(B3DetectorConstruction* detConstruction)
...
void B3bActionInitialization::Build() const
{
  ...
  SetUserAction(new B3PrimaryGeneratorAction(fDetConstruction));
  
  SetUserAction(new B3bRunAction);

  B3bEventAction* eventAction = new B3bEventAction();  
  SetUserAction(eventAction);
  //SetUserAction(new B3bTrackingAction(eventAction));
  SetUserAction(new B3bSteppingAction(fDetConstruction,eventAction));
