...
class B3DetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
    ...
    const G4VPhysicalVolume* GetEff(int i) const;    

  private:
    void DefineMaterials();

    G4VPhysicalVolume* phys_virsual; 
    G4VPhysicalVolume* phys_eff; 
...
inline const G4VPhysicalVolume* B3DetectorConstruction::GetEff(int i) const
{
	if(i==1){
		return phys_eff;
	}
