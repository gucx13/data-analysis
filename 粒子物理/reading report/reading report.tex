...
We could treat the standard model as toy brick, and the particle as bloc
...
\subsection{Particle Table }

\begin{table}[hbt]
\caption{Table of Particle}
\centering
\begin{tabular}{lllr}
\toprule
...
\paragraph{Paragraph Description}  % Dummy text

\paragraph{Different Paragraph Description} % Dummy text
